package com.shoe_store.in_memory_info;

import com.shoe_store.in_memory_info.in_memory_m_t_m_tables.UserFavouriteRecipe;
...
public final class InMemoryInfo {
    ...
    private void initUsers() {
        ...
        users.add(new User(3L, "admin", "adminpass", "admin@example.com", true));
    }
